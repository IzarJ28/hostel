   ...
   <div class="my-5 px-4">
      <h2 class="fw-bold h-font text-center">CONTACT US</h2>
       ...
       Lorem ipsum, dolor sit amet consectetur adipisicing elit.
        Est consequatur aspernatur minima, pariatur numquam assumenda ullam!
       </p>
   </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 px-4">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="message" required class="form-control sahdow-none"  rows="5 " style="resize: none;"></textarea>
                </div>
