<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
      <h3 class="mb-0 h-font">BSU-Arasof</h3>
             ...
             <div class="container-fluid flex-lg-column align-items-strech ">
                ...
                <div class="collapse navbar-collapse flex-column align-items-strech mt-2" id="adminDropdown">
                   <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="user_message.php">User Message</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="banguet.php">Banguet</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="hostel.php">Hostel</a>
                        </li>
                        <li class="nav-item">
